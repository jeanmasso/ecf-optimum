...
<main id="maincontent" role="main">
  ...
  <?php if( get_theme_mod( 'vw_fitness_slider_hide_show', false) != '' || get_theme_mod( 'vw_fitness_resp_slider_hide_show', false) != '') { ?>
            ...
            <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
              ...
              <div class="carousel-caption">
                <div class="inner_carousel">
                  ...
                  <p class="wow slideInRight" data-wow-duration="3s"><?php $excerpt = get_the_excerpt(); echo esc_html( vw_fitness_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_fitness_slider_excerpt_number','30')))); ?></p>
                  <?php if( get_theme_mod('vw_fitness_slider_button_text','READ MORE') != ''){ ?>
                    <div class="more-btn wow slideInLeft" data-wow-duration="3s">              
  ...
  <section class="our-services wow lightSpeedIn delay-1000">
    <div class="container">
      <div class="row">
