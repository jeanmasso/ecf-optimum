...
function vw_fitness_scripts() {
	...
	wp_enqueue_script( 'vw-fitness-jquery-wow', esc_url(get_template_directory_uri()) . '/js/wow.js', array('jquery') );
	wp_enqueue_style( 'vw-fitness-animate-css', esc_url(get_template_directory_uri()).'/css/animate.css' );
